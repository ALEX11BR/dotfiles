...
sudo xbps-install -Suf NetworkManager zsh zsh-completions zsh-syntax-highlighting zsh-autosuggestions lightdm lightdm-gtk3-greeter qt5-styleplugins gnome-themes-extra breeze-icons mesa-dri network-manager-applet alacritty qbittorrent gvim git unrar p7zip xdg-user-dirs-gtk gvfs-mtp rofi parcellite picom octoxbps gst-libav gst-plugins-bad1 gst-plugins-good1 gst-plugins-ugly1 cups hplip nvidia nvidia-libs-32bit intel-video-accel xorg-minimal elogind pulseaudio alsa-plugins-pulseaudio bluez blueman acpilight font-awesome noto-fonts-ttf noto-fonts-emoji noto-fonts-cjk libreoffice chromium
if [ "$1" = "bspwm" ]; then
