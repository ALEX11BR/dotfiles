...
if [ "$1" = "bspwm" ]; then
	sudo apt-get install bspwm sxhkd polybar picom parcellite gmrun kitty maim numlockx xss-lock xsecurelock udiskie rofi network-manager-gnome blueman notification-daemon xsettingsd gnome-keyring
fi
