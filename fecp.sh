...
if [ "$1" = "bspwm" ]; then
	sudo dnf install -y bspwm polybar rofi rofimoji picom xsettingsd gnome-keyring parcellite blueman xfce4-notifyd maim file-roller numlockx network-manager-applet udiskie dnfdragora-updater
fi
