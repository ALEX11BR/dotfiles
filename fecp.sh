...
sudo dnf install -y flatpak google-noto-\* vlc gstreamer1-plugins-{bad-\*,good-\*,ugly-\*,base} gstreamer1-plugin-openh264 gstreamer1-libav lame\* libdvdcss playerctl xclip sxhkd python3-pyusb
...
if [ "$1" = "bspwm" ]; then
	sudo dnf install -y bspwm polybar rofi rofimoji picom xsettingsd xss-lock xsecurelock gnome-keyring parcellite blueman xfce4-notifyd maim file-roller numlockx network-manager-applet udiskie dnfdragora-updater
fi
